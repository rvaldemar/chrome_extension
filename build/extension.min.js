var _hokojs = (function () {
  'use strict';

  function addNavbarBtn() {
  ...
  function fetchAllQuestions(callback) {
    return axios$1.get(domain + '/api/v1/questions');
  }

  //fetchQuestion
  function fetchQuestion(questionId) {
    return axios$1.get(domain + '/api/v1/questions/' + questionId);
  }
  ...
  */
  ...
  var header$2 = document.getElementById('exercise-header');

  header$2.parentNode.innerHTML = '<form id="new-question"> <div id="editor"> <p>Hello !</p> <p>Some initial <strong>bold</strong> text</p> <p><br></p></div> <button id="submit" class="btn btn-primary" type="submit">Send</button></form>';
  ...
  var submit = function (event) {
    ...
    axios$1.post('http://localhost:3000/api/v1/questions', {
      question: {
        content: quill,
        username: userName,
        title: title,
